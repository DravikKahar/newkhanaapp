...
const navigation: NavigationItem[] = [
    ...
    { name: 'Personalized', href: '/personalized', current: false },
    { name: 'Subscription', href: '#home-section', current: false },
                        ...
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className='gap-6 hidden lg:flex'>
                                <div className='flex items-center gap-2'>
                                    ...
                                    <p className='text-lg font-medium'><a href="tel:9033973532">9033973532</a></p>
                                </div>
