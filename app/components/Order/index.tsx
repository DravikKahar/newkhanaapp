      ...
      <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1">
          <div className="col-span-6 flex flex-col justify-center">
            ...
            <button
              type="submit"
              className="flex justify-center text-xl font-medium bg-bgpink text-pink mt-5 py-4 px-4 lg:px-8 navbutton rounded-full hover:text-white hover:bg-pink"
            // >
            //   Place Order
            // </button>
            // <button
